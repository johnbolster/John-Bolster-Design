...
export const projects: Project[] = [
  {
    ...
    description: "Veterans and first responders dealing with trauma don't trust the system. They've been through it. The clinical model has failed them enough times that \"get help\" has stopped meaning anything. Alliance 180 operates on a completely different premise: peer-to-peer, action-based, built around trust rather than treatment.\n\nThe branding challenge was matching that. A traditional nonprofit look would have signaled the same institutional language this audience had already tuned out. The brand needed to feel like it was built by and for the people it serves, not handed down from above.\n\nWe built a system around momentum and transformation, grounded in the idea of \"doing a 180\", a shift that's physical and active, not passive and clinical. Bold typography and a high-energy visual language reflect the action-based nature of the program. The tone is direct and peer-level, not clinical or charitable. The result is a brand that meets veterans and first responders on their terms, making it easier to reach the people who need it most and harder to dismiss as just another program asking for trust they haven't earned yet.",
    client: "Alliance 180",
