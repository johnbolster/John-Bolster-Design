...
export const projects: Project[] = [
  {
    ...
    description: "Alliance180 wasn’t just another mental health program. It was a fundamentally different approach to trauma recovery built on peer connection and horse-to-human interaction. The challenge was making that believable. The audience was skeptical. Many had already tried traditional therapies that didn’t work. The idea of working with horses didn’t immediately translate to trust.\n\nSo the work started with clarity. We anchored the brand in something people could understand: trust, communication, and the physiological reality of trauma. Not a therapy promise, but a new direction.\n\nFrom there, everything else followed. A compass-driven identity to represent finding direction again. A grounded, restrained color system to avoid anything overly emotional or performative. A voice that was direct, empathetic, and honest without over-explaining.\n\nThe result wasn’t just a visual identity. It was a brand that felt credible to people who don’t trust easily, clear to people who don’t have the language for what they’re going through, and strong enough to carry the mission forward.",
    client: "Alliance 180",
